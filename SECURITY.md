...
2. **Email** — `security@blockharbor.example.com` with subject `[BlockHarbor SECURITY]`. Encrypt with PGP if the issue is critical (key forthcoming; ask for the fingerprint).
